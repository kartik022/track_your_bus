...
import 'package:track_your_bus/services/auth_provider.dart';
import 'package:track_your_bus/screens/auth.dart';
import 'package:track_your_bus/screens/find_bus.dart';
import 'dart:async';

class DrawerWidget extends StatefulWidget {
  const DrawerWidget({Key? key,required this.name, required this.userID, required this.institute}) : super(key: key);
